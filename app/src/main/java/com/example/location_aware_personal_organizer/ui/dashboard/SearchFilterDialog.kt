...
fun FilterDialog(
    ...
    onApplyFilters: (String, String, LocalDate?) -> Unit,
    onDismiss: () -> Unit
) {
    ...
    AlertDialog(
        ...
        title = { Text("Search & Filter Tasks") },
        text = {
            Column {
                OutlinedTextField(
                    value = query,
                    onValueChange = { query = it },
                    label = { Text("Search by title/description") },
                ...
                Row(
                    ...
                    Text("Filter by deadline:", modifier = Modifier.weight(1f))
        ...
        confirmButton = {
            TextButton(
                onClick = {
                    onApplyFilters(query, location, selectedDate)
                    onDismiss()
                }
            ) {
                Text("Apply")
